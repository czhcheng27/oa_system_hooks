...
import Clipboard from "./pages/echarts/clipboard/index";
import CssAdsorb from "./pages/echarts/CssAdsorb/index";
import SwitchTheme from "./pages/echarts/SwitchTheme/index";
import AnimationDelay from "./pages/echarts/AnimationDelay/index";
...
import ElectronicSignature from "./pages/echarts/ElectronicSignature/index";
import AttributeDrag from "./pages/drag/AttributeDrag";
import AdvanceFilter from "./pages/echarts/AdvanceFilter/index";
